...
export default function ProductDetailPage({ params }: PageProps) {
  ...
  const subcategory = !isDirectProduct
    ? (product.subcategory as Subcategory | undefined)
    : undefined
        ...
        <div className="product-detail__container">
          <div className="product-detail__layout">
            ...
            <div className="product-detail__info">
              {product.featured && <span className="product-detail__badge">Featured Product</span>}
              ...
              {product.finishes && product.finishes.length > 0 && (
                ...
                >
                  <h3 className="product-specs__title">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                      <path
                        d="M7 21C5.895 21 5 20.105 5 19V5C5 3.895 5.895 3 7 3H17C18.105 3 19 3.895 19 5V19C19 20.105 18.105 21 17 21M7 21H17M7 21V18M17 21V18M7 18H17M7 18V15M17 18V15M7 15H17M7 15V12M17 15V12M7 12H17"
                        stroke="currentColor"
                        strokeWidth="2"
                        strokeLinecap="round"
                      />
              ...
              <div style={{ marginTop: '32px' }}>
                <Link href="/contact" className="enquiry-btn">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                    <path
                      d="M3 8L10.89 13.26C11.2187 13.4793 11.6049 13.5963 12 13.5963C12.3951 13.5963 12.7813 13.4793 13.11 13.26L21 8M5 19H19C20.105 19 21 18.105 21 17V7C21 5.895 20.105 5 19 5H5C3.895 5 3 5.895 3 7V17C3 18.105 3.895 19 5 19Z"
                      stroke="currentColor"
                      strokeWidth="2"
                      strokeLinecap="round"
                      strokeLinejoin="round"
            ...
            <div className="products-grid__grid">
              {(product.relatedProducts as Product[]).slice(0, 3).map((related) => {
                ...
                const relatedCategorySlug =
                  ...
                  (relatedSubcategory?.category as Category)?.slug ||
                  categorySlug
                ...
                return (
                  <Link href={relatedUrl} key={related.id} className="product-card">
