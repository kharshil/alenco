...
export default async function CategoryPage({ params }: PageProps) {
  ...
  const categoryImage =
    getImageUrl(category.bannerImage as Media) || getImageUrl(category.image as Media)
  ...
  return (
    <div className="category-page">
      ...
      {/* Breadcrumb */}
      <Breadcrumb
        items={[{ label: 'Products', href: '/#hardware-products' }, { label: category.name }]}
      />
      ...
      <section className="products-grid">
        <div className="products-grid__container">
          {subcategories.length > 0 ? (
            ...
            <ProductsGrid products={products} title="Products" showCount={true} />
          ) : (
            <>
              <div className="products-grid__header">
...
export async function generateMetadata({ params }: PageProps) {
  ...
  return {
    ...
    description:
      ...
      category.shortDescription ||
      `Explore ${category.name} products from Alenco`,
